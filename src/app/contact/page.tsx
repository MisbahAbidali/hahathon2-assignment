           ...
           <div className="navbar3">
            <img src ="navbar-dark (1).png" alt="navbar"></img>
               ...
               <div className="navbar5">
                ...
                <img src="navbar-style-7 navbar-light (1).svg" alt="navbar"></img>
              </div>
             </div>
              <div>
               <img src="container (3).svg" alt="navbar"></img>
                 </div>
                   <div className="carousel">
                      <div className="md:flex md:pl-10">
                      <img src="carousel 2 (1).svg" alt="image"></img>                    
                       <div className=" pl-[40px] mt-[20px] md:pl-10">
                       <h3 className="text-2xl ">Floating Phone</h3>
                       <div className="mt-[10px]  ">
                       <img src="Frame 31.png" alt="image"></img>
                       </div>
                       <div className="mt-[10px] ">
                       <h1 className="text-2xl font-bold ">$1,1139.33</h1>
                       </div>
                       <div className="mt-[6px] ">
                       <img src="div.png" alt="image"></img>
                       </div>
                       <div className="para ">
                       <p className="font-semibold">Met minim Mollie non desert Alamo est sit cliquey dolor do met sent. RELIT official consequent door ENIM RELIT Mollie. Excitation venial consequent sent nostrum met.</p>
                       <div className="pt-[30px] ">
                       <img src="product-colors.svg" alt="image"></img>
                       </div>
                       <div className="btn">
                        <button className="font-semibold text-white">Select Options</button>
                       </div>                                                                 
                    </div>
                   </div>
                </div>
                     ...
                     <div className="bar">
                  <img src="nav.svg" alt="nav"></img>
              </div>  
              <div className="content-a">
                <div className="md:flex">
                <img src="col-md-4.svg" alt="img"></img>
                <div>
                <div className="bold">
                <h1 className="text-3xl font-bold pl-[20px] mt-[40px]">the quick fox jumps over </h1>
                </div>
                <div className="para2">
              ...
              <div className="cont">
                <h1 className="text-3xl font-bold pl-[30px] mt-[40px]">BESTSELLER PRODUCTS</h1>
              </div>    
              <div className="image3">
             <div className="flex gap-10 pl-[60px]">
                <img src="fixed-height (10).png" alt="image"></img>
                <img src="fixed-height (11).svg" alt="image"></img>  
                <img src="fixed-height (13).svg" alt="image"></img>  
                <img src="fixed-height (12).svg" alt="image"></img>  
             </div>
          </div>
          <div className="text6">
          ...
          <div className="text7">
            <div className="flex gap-40">
             ...
             <div className="content">
              ...
              <div className="image3">
             <div className="flex gap-10 pl-[60px]">
                <img src="fixed-height (9).svg" alt="image"></img>
                <img src="product-cover-5 (6).svg" alt="image"></img>  
                <img src="fixed-height (10).png" alt="image"></img>  
                <img src="fixed-height (11).svg" alt="image"></img>  
             </div>
          </div>
            ...
            <div className="flex gap-40">
             ...
             <div className="content">
              ...
              <div className="content3">
                 <img src="fixed-height (10).png" alt="img"></img>
             ...
             <div className="content3">
                 <img src="fixed-height (11).svg" alt="img"></img>
                 <div className="pl-[50px]">
                 <h1 className="text-1xl font-bold pl-[15px] mt-[30px]">Graphic Design</h1>
                 <p className="text-1xl">English Department</p>
                 <div className="pl-[15px]"><img src="prices.svg" alt="sorry"></img></div>
             ...
             <div className="content3">
               <div>
                <img src="fixed-height (13).svg" alt="img"></img>
                <div className="pl-[50px]">
                 <h1 className="text-1xl font-bold pl-[15px] mt-[30px]">Graphic Design</h1>
                 <p className="text-1xl">English Department</p>
                 <div className="pl-[15px]"><img src="prices.svg" alt="sorry"></img></div>
             ...
             <div className="content3">
               <div>
                <img src="product-cover-5 (6).svg" alt="img"></img>
                <div className="pl-[50px]">
                 <h1 className="text-1xl font-bold pl-[15px] mt-[30px]">Graphic Design</h1>
                 <p className="text-1xl">English Department</p>
                 <div className="pl-[15px]"><img src="prices.svg" alt="sorry"></img></div>
             ...
             <div className="ul2">
                  <img src="desktop-clients-1 (1).svg" alt="img"></img>
             </div>
             <div className="clients">
            <img src="mobile-clients-1.svg" alt="img"></img>
            </div>
